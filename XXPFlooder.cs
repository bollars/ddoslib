...
namespace LOIC
{
	class XXPFlooder : IFlooder
    {
        ...
        #region Constructors
        /// <summary>
        /// This flooder floods via the TCP or UDP protocol. proto is either 1 or 2, TCP or UDP. Resp is whether to wait until the site being stress
        /// tested responds to send more packets.
        /// </summary>
